...
func (c *CROSS) expand_digest_to_fixed_weight(digest_chall_2 []byte) []bool {
...
func (c *CROSS) expandSK(seed_sk []byte) ([]byte, [][]byte) {
...
func (c *CROSS) Sign(sk, msg []byte) ([][]byte, error) {
